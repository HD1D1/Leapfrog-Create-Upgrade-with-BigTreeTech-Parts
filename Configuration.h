...
#define STRING_CONFIG_H_AUTHOR "(D's leapfrog)" // Who made the changes.
...
//#define MAGNETIC_PARKING_EXTRUDER
  ...
  #define PARKING_EXTRUDER_GRAB_DISTANCE 1            // (mm) Distance to move beyond the parking point to grab the extruder
    ...
    #define PARKING_EXTRUDER_SOLENOIDS_	// If enabled, the solenoid is NOT magnetized with applied voltage
